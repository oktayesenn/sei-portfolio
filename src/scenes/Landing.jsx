      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          >
            <img
              alt="profile"
              className="hover:filter hover:saturate-200 transition duration-500 z-10 w-full max-w-[400px] md:max-w-[450px]"
              src= {nyc}
            />
          </div>
        ) : (
          <img
            alt="profile"
            className="z-10 w-full max-w-[450px] md:max-w-[450px]"
            src={nyc}
          />
        )}
      </div>
